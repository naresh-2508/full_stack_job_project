...
export const employerGellAllApplications=catchAsyncError(async(req,res,next)=>{
    const {role}=req.user;
    if(role==="Job Seeker")
        {
...
export const jobseekerGellAllApplications=catchAsyncError(async(req,res,next)=>{
    const {role}=req.user;
    if(role==="Employer")
        {
...
export const postApplication=catchAsyncError(async(req,res,next)=>{
    ...
    {
        return next(new ErrorHandler("Resume file reuired!",400));
    }
